...
DATA_DIRECTORIES = ['data', 'data_2', 'data_3', 'data_4']
LOG_FILE = 'driving_log.csv'
MODEL_DIR = 'model_2017_04_04'
MODEL_NAME = 'model.h5'
...
def train_model(model, x, y):
    ...
    model.fit(x, y, validation_split=0.2, shuffle=True, nb_epoch=4, batch_size=128)
